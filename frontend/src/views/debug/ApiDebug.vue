      ...
      <div class="response-header">
        ...
        <div class="response-header-actions">
          <a-button size="small" type="link" @click="assertionDrawerVisible = true">
            <SafetyCertificateOutlined /> 断言校验
...
const assertionBadge = computed(() => {
  ...
  if (assertionSummary.value.fail > 0) return { text: `${assertionSummary.value.fail} 失败`, class: 'badge-fail' }
  return { text: `${assertionSummary.value.pass} 通过`, class: 'badge-pass' }
})
